...
class TSColor {
    ...
    /// 海马所给相关颜色
    class var haimaColor: haimaColors {
        return haimaColors()
    }
    class var cell: CellContentColor {
        return CellContentColor()
    }
...
class haimaColors {
    /// 主题色
    ///
    /// - 产品主题色,常用导航、链接、按钮、icon等,需要强调
    var theme: UIColor {
        return UIColor(hex: 0xFDDA43)
    }
    
    /// 主题色
    ///
    /// - 常用头部导航、icon等,需要强调
    var themeOther: UIColor {
        return UIColor(hex: 0x39383E)
    }
    ...
    var secondTextColor: UIColor {
        return UIColor(hex: 0x9c9c9c)
    }
    
    /// 文字色
    ///
    /// - 提示性文字,说明类
    var otherTipColor: UIColor {
        return UIColor(hex: 0xc5c5c5)
    }
    
    /// 背景色
    ///
    /// - 用于内容背景色
    var contentBackColor: UIColor {
        return UIColor(hex: 0xF1F0F6)
    }
...
class MainColor {
    ...
    var theme: UIColor {
        return UIColor(hex: 0xf9dc40)
    }
    /// 底部导航标题颜色
    var tabbarTheme: UIColor {
        return UIColor(hex: 0x39383e)
    }
    /// 正文, 内容以及标题颜色
    ///
...
class ButtonColor {
    ...
    /// 主题黄
    var yellowSelected: UIColor {
        return UIColor(hex: 0xFDDA43)
    }
}
class CellContentColor {
    /// 左侧标题
