...
//  Demo
//
//  Created by gongpengyang on 2018/5/4.
//  Copyright © 2018年 YLJ. All rights reserved.
//

import UIKit
/**
 协议加入 @objc 因为要使用到oc的responds所以
 协议方法前加入 @objc optional
 */
/// 导航返回协议
...
extension UINavigationController: UINavigationBarDelegate, UIGestureRecognizerDelegate {
    ...
    public func navigationBar(_ navigationBar: UINavigationBar, shouldPop item: UINavigationItem) -> Bool {
        ...
        if vc.responds(to: #selector(navigationShouldPopMethod)) {//responds是oc方法
