...
//    }
    ...
    class func returnCunguanUrlWith(Url url:String) -> String {
        let str_one = KYNetWorkTool.tool.localPara["signa"] as! String
        let str_two = KYNetWorkTool.tool.localPara["ts"] as! String
        let str_three = KYNetWorkTool.tool.localPara["oauth_token"] as! String
